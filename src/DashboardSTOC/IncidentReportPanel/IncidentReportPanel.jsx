...
function IncidentReportPanel({ closePanel }) {
    ...
    const fetchIncidentHistory = async () => {
        ...
        const url = `https://backendthirdv.onrender.com/api/detection-history${queryString ? `?${queryString}` : ""}`;
    ...
    const handleDelete = async (detection_ID) => {
        ...
        try {
            const response = await fetch(`https://backendthirdv.onrender.com/api/delete-detection/${detection_ID}`, {
                method: "DELETE",
            });
