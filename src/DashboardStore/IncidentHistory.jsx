...
function IncidentHistory({ closePanel, storeID }) {
    ...
    const fetchIncidentHistory = async () => {
        ...
        const url = `http://backendthirdv.onrender.com/api/incident-history/${storeID}${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
    ...
    const handleDelete = async (shared_detection_id) => {
        ...
        try {
            const response = await fetch(`http://backendthirdv.onrender.com/api/delete-detection-store/${shared_detection_id}`, {
                method: "DELETE",
            });
    ...
    const handleSaveEdit = async (updatedIncident) => {
        try {
            const response = await fetch(`http://backendthirdv.onrender.com/api/edit-incident/${updatedIncident.detection_ID}`, {
                method: "PUT",
